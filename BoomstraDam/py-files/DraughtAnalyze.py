...
class DraughtAnalyze:
    def __init__(self, main):
        ...
        self.Game_1 = GameRecord(main,  None, None)
        self.Game_2 = GameRecord(main,  None, None)
        self.Game_3 = GameRecord(main,  None, None)
    ...
    def receive_all_moves(self, msg):
        ...
        for j in range(0, cnt):
            ...
            #print next_move
            self.InsertValue(Start,  Stop,  MoveValue)
    ...
    def InsertValue(self,  start,  stop,  value):  
