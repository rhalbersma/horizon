...
##        self.root.bind("p",self.main.stand.previous_line)
        ...
        self.viewmenu.add_command(label="Sound -- On", command=self.set_sound_level)
        ...
        self.auto_move.set(0)                                                          # set it on
...
##        self.depth_list_box.see(3)
        ...
        self.notation = Text(self.frame_notation_frame)
        self.notation.grid()
        self.notation.insert(END, "Welcome")
        self.notation.config(font = ("Courier", 10))
    ...
    def set_sound_level(self):
        if self.sound_mode == dc.SOUND_ON:
            self.sound_mode = dc.SOUND_TWO
            self.viewmenu.entryconfig(0, label='Sound -- TWO')
        elif self.sound_mode == dc.SOUND_TWO:
            self.sound_mode = dc.SOUND_OFF
            self.viewmenu.entryconfig(0, label='Sound -- Off')
        elif self.sound_mode == dc.SOUND_OFF:
