...
#        self.frame_overall_frame          = Frame(self.root, relief = GROOVE, bd =4)
        ...
        self.filemenu.add_command(label="Save Single Move Position",  command=self.main.save_single_move_position)
        #self.filemenu.add_command(label="Make Records", command=self.main.make_game_records.MakeOpening)
        #self.filemenu.add_command(label="Convert", command=self.main.convert_all_files)
        ...
        self.remotemenu.add_command(label="Make Lost Docs", command=self.main.make_lost_docs)
...
##        self.depth_list_box.see(3)
        ...
        self.notation = Text(self.frame_notation_frame, height = 18)
