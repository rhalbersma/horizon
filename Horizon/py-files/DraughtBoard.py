...
class BigDraughtBoardView:
    HEIGHT=60               # height of a square on the board
    WIDTH=60                # width of a square on the board
    ...
    def __init__(self, board_frame):
        ...
        self.entire_board_frame = board_frame
        self.service_frame = Frame(self.entire_board_frame, height=10*self.HEIGHT, width=self.WIDTH,      bd=4, relief=RAISED)
        self.board_frame   = Frame(self.entire_board_frame, height=10*self.HEIGHT, width=10*self.WIDTH, bd=4, relief=RAISED, bg="#b0b0b0")
        self.service_frame.grid(row=0,column=0)
        self.board_frame.grid(row=0,column=1)
        self.entire_board_frame.rowconfigure(0, weight=100)
        # define the draught board itself
        self.empty_field          = PhotoImage(file="/home/feike/Horizon/images/empty_field.gif")
        self.empty_field_selected = PhotoImage(file="/home/feike/Horizon/images/empty_field_selected.gif")
        self.empty_field_proposed = PhotoImage(file="/home/feike/Horizon/images/empty_field_proposed.gif")
        self.white_man            = PhotoImage(file="/home/feike/Horizon/images/white_man.gif")
        self.white_man_selected   = PhotoImage(file="/home/feike/Horizon/images/white_man_selected.gif")
        self.white_man_proposed   = PhotoImage(file="/home/feike/Horizon/images/white_man_proposed.gif")
        self.white_king           = PhotoImage(file="/home/feike/Horizon/images/white_king.gif")
        self.white_king_selected  = PhotoImage(file="/home/feike/Horizon/images/white_king_selected.gif")
        self.white_king_proposed  = PhotoImage(file="/home/feike/Horizon/images/white_king_proposed.gif")
        self.black_man            = PhotoImage(file="/home/feike/Horizon/images/black_man.gif")
        self.black_man_selected   = PhotoImage(file="/home/feike/Horizon/images/black_man_selected.gif")
        self.black_man_proposed   = PhotoImage(file="/home/feike/Horizon/images/black_man_proposed.gif")
        self.black_king           = PhotoImage(file="/home/feike/Horizon/images/black_king.gif")
        self.black_king_selected  = PhotoImage(file="/home/feike/Horizon/images/black_king_selected.gif")
        self.black_king_proposed  = PhotoImage(file="/home/feike/Horizon/images/black_king_proposed.gif")
...
##            self.c[i].bind("<Button-3>", self.right_button_pressed)
    ...
    def set_empty_field(self, i, selected=False, proposed=False):
        if self.invert_board.get() == 1:
            j = 51 - i
        else:
            j = i
        if selected == True:
            ...
            self.c[j].itemconfigure(self.image_item[j], image=self.empty_field_proposed)
        else:
            self.c[j].itemconfigure(self.image_item[j], image=self.empty_field)
        return

    def set_white_man(self, i, selected=False, proposed=False):
        if self.invert_board.get() == 1:
            j = 51 - i
        else:
            j = i
        if selected == True:
            ...
            self.c[j].itemconfigure(self.image_item[j], image=self.white_man_proposed)
        else:
            self.c[j].itemconfigure(self.image_item[j], image=self.white_man)
        return

    def set_white_king(self, i, selected=False, proposed=False):
        if self.invert_board.get() == 1:
            j = 51 - i
        else:
            j = i
        if selected == True:
            self.c[j].itemconfigure(self.image_item[j], image=self.white_king_selected)
        elif proposed == True:
            self.c[j].itemconfigure(self.image_item[j], image=self.white_king_proposed)
        else:
            self.c[j].itemconfigure(self.image_item[j], image=self.white_king)
        return

    def set_black_man(self, i, selected=False, proposed=False):
        if self.invert_board.get() == 1:
            j = 51 - i
        else:
            j = i
        if selected == True:
            ...
            self.c[j].itemconfigure(self.image_item[j], image=self.black_man_proposed)
        else:
            self.c[j].itemconfigure(self.image_item[j], image=self.black_man)
        return

    def set_black_king(self, i, selected=False, proposed=False):
        if self.invert_board.get() == 1:
            j = 51 - i
        else:
            j = i
        if selected == True:
            ...
            self.c[j].itemconfigure(self.image_item[j], image=self.black_king_proposed)
        else:
...
if __name__=='__main__':
  ...
  board = Frame(top)
  board.grid()
  panel = BigDraughtBoardView(top)

  for i in range(1, 21):
    panel.set_black_man(i)
  for i in range(31, 51):
    panel.set_white_man(i)
  panel.set_white_man(33, True, False)
  panel.set_empty_field(28, True, False)
  top.mainloop()
