...
class EvalParameters:
    def __init__(self):
        ...
        self.corner_35=StringVar()
        self.corner_36=StringVar()
...
class DraughtEval:
    def __init__(self, eval_frame):
        ...
        Label(eval_frame, text="centrum",anchor=W).grid(column=0,row=7,sticky=W)
        Label(eval_frame, text="mobility",anchor=W).grid(column=0,row=8,sticky=W)
        Label(eval_frame, text="edge",anchor=W).grid(column=0,row=9,sticky=W)
        ...
        Label(eval_frame, text="corner_35",anchor=W).grid(column=0,row=22,sticky=W)
        Label(eval_frame, text="corner_36",anchor=W).grid(column=0,row=23,sticky=W)
        ...
        Label(eval_frame, textvariable=self.white.centrum,anchor=E,bg="#fff").grid(column=1,row=7,sticky=E)
        Label(eval_frame, textvariable=self.white.mobility,anchor=E,bg="#fff").grid(column=1,row=8,sticky=E)
        Label(eval_frame, textvariable=self.white.edge,anchor=E,bg="#fff").grid(column=1,row=9,sticky=E)
        ...
        Label(eval_frame, textvariable=self.white.corner_35,anchor=E,bg="#fff").grid(column=1,row=22,sticky=E)
        Label(eval_frame, textvariable=self.white.corner_36,anchor=E,bg="#fff").grid(column=1,row=23,sticky=E)
        ...
        Label(eval_frame, textvariable=self.black.centrum,anchor=E,bg="#eee").grid(column=2,row=7,sticky=E)
        Label(eval_frame, textvariable=self.black.mobility,anchor=E,bg="#eee").grid(column=2,row=8,sticky=E)
        Label(eval_frame, textvariable=self.black.edge,anchor=E,bg="#eee").grid(column=2,row=9,sticky=E)
        ...
        Label(eval_frame, textvariable=self.black.corner_35,anchor=E,bg="#eee").grid(column=2,row=22,sticky=E)
        Label(eval_frame, textvariable=self.black.corner_36,anchor=E,bg="#eee").grid(column=2,row=23,sticky=E)
        ...
        Label(eval_frame, textvariable=self.diff.centrum,anchor=E,bg="#fff").grid(column=3,row=7,sticky=E)
        Label(eval_frame, textvariable=self.diff.mobility,anchor=E,bg="#fff").grid(column=3,row=8,sticky=E)
        Label(eval_frame, textvariable=self.diff.edge,anchor=E,bg="#fff").grid(column=3,row=9,sticky=E)
        ...
        Label(eval_frame, textvariable=self.diff.corner_35,anchor=E,bg="#fff").grid(column=3,row=22,sticky=E)
        Label(eval_frame, textvariable=self.diff.corner_36,anchor=E,bg="#fff").grid(column=3,row=23,sticky=E)
    ...
    def display(self, eval):
        ...
        self.white.centrum.set(self.scrap_zero(eval[31:36]))
        self.white.mobility.set(self.scrap_zero(eval[36:41]))
        self.white.edge.set(self.scrap_zero(eval[41:46]))
        ...
        self.white.corner_35.set(self.scrap_zero(eval[106:111]))
        self.white.corner_36.set(self.scrap_zero(eval[111:116]))
        ...
        self.black.centrum.set(self.scrap_zero(eval[181:186]))
        self.black.mobility.set(self.scrap_zero(eval[186:191]))
        self.black.edge.set(self.scrap_zero(eval[191:196]))
        ...
        self.black.corner_35.set(self.scrap_zero(eval[256:261]))
        self.black.corner_36.set(self.scrap_zero(eval[261:266]))
        ...
        self.set_diff(self.white.centrum,self.black.centrum,self.diff.centrum)
        self.set_diff(self.white.mobility,self.black.mobility,self.diff.mobility)
        self.set_diff(self.white.edge,self.black.edge,self.diff.edge)
        ...
        self.set_diff(self.white.corner_35,self.black.corner_35,self.diff.corner_35)
        self.set_diff(self.white.corner_36,self.black.corner_36,self.diff.corner_36)
